...
const { BOT_TOKEN, BOT_PREFIX, SERVERID } = require(".env)
  ...
  if(message.guild) {
      if(command == "setup") {
        ...
        if(message.channel.parentID == message.guild.channels.cache.find((x) => x.name == "MODMAIL").id) {
          ...
          if(!category) {
              return message.channel.send("Moderation system is not setuped in this server, use " + BOT_PREFIX + "setup")
          }
        ...
        .addField(BOT_PREFIX + "setup", "Setup the modmail system(This is not for multiple server.)", true)
  
        .addField(BOT_PREFIX + "open", 'Let you open the mail to contact anyone with his ID', true)
        .setThumbnail(client.user.displayAvatarURL())
                    .addField(BOT_PREFIX + "close", "Close the mail in which you use this command.", true);
